...
import residence from '../assets/residence-website.jpg'
...
const Work = () => {
  ...
  return (
    <div name='work' className='bg-[#18191b] text-[#f4f4f4] w-full md:h-screen '>

{/* container */}
<div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full mt-8'>
    <div className='pb-8'>
        <p className='text-4xl font-bold inline border-b-4 border-[#f1b007]'>Work</p>
        ...
        {work.map((item) =>(
          <div  key={item.id} className='shadow-md shadow-[#001] rounded-lg  '>
            ...
            <div className='flex items-center justify-center'>
              ...
              <button className='w-[65%] px-6 py-3 m-4 duration-200 hover:scale-105 font-bold text-center hover:bg-yellow-600'>Demo</button>
              </a>
              <a href={item.code} target="_blank" rel="noreferrer">
              <button className='w-[65%] px-6 py-3 m-4 duration-200 hover:scale-105 font-bold hover:bg-yellow-600 '>Code</button>
              </a>
